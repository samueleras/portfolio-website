            ...
            <div ref={elementRef} className="container mx-auto">
              ...
              >
                ...
                >
                  ...
                  >
                    {showFullDescription || window.innerWidth >= 1024
                      ? t(project.descriptionKey)
                      : t(project.descriptionKey).slice(0, 300) + "..."}
                  </p>
                  {t(project.descriptionKey).length > 300 && (
                    <button
                      onClick={() =>
                        setShowFullDescription(!showFullDescription)
                      }
                      className={`mt-4 text-sm font-medium transition-colors lg:hidden ${
                        theme === "dark"
                          ? "text-white hover:text-white/80 bg-white/10 hover:bg-white/20 px-3 py-1 rounded"
                          : "text-gray-700 hover:text-gray-800 bg-gray-100 hover:bg-gray-200 px-3 py-1 rounded"
                      }`}
                    >
                      {showFullDescription
                        ? t("projectDetail.showLess")
                        : t("projectDetail.showMore")}
                    </button>
                  )}
                </div>
              </div>
